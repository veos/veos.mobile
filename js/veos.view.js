  ...
  **/
  ...
  self.InstallationDetails = Backbone.View.extend({
    ...
    createPointDetailsMap: function(installation) {
      ...
      var staticMapCriteria = "https://maps.googleapis.com/maps/api/staticmap?zoom=14&size=200x100&scale=2&sensor=true&center=" + installation.get('loc_lat') + "," + installation.get('loc_lng');
