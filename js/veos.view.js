  ...
  **/
  self.ReportForm = Backbone.View.extend({
    ...
    submit: function () {
      ...
      // clear out the old error messages generated by defaultErrorHandler
      // TODO we should probably also be keeping track of which elements are redded by the errorHandler, and remove the red once the field is filled
      jQuery('#error-message-container').empty();
...
// **************************************************************************************************************** //
  ...
  self.ReportEditForm = Backbone.View.extend({
    ...
    submit: function () {
      ...
      // clear out the old error messages generated by defaultErrorHandler
      // jQuery('#error-message-container').remove();
